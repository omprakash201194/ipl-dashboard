 ...
 * Created on 11-Jun-21 at 9:31 PM.
 */
...
public class BatchConfig {
    ...
    public static final String[] FIELDS = {"id","city","date","player_of_match","venue","neutral_venue","team1",
    ...
    public JdbcBatchItemWriter<Match> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Match>()
                ...
                .sql("INSERT INTO match (id,city,date,player_of_match,venue,neutral_venue,team1,team2,toss_winner," +
                        "toss_decision,winner,result,result_margin,eliminator,method,umpire1,umpire2) " +
                        "VALUES (:id, :city, :date, :playerOfMatch, :venue, :neutralVenue, :team1, :team2, :tossWinner," +
